...
from wjjtfbs.models.noBiLSTM import CLAModel


class Constructor:
    def __init__(self, model_class, dataset_name, variant='noBiLSTM'):
...
if __name__ == '__main__':
    ...
    all_results = []
    csv_file = 'evaluation_results_noBiLSTM.csv'
    ...
    for i, name in enumerate(datasets):
        ...
        try:
            trainer = Constructor(CLAModel, name, variant='noBiLSTM')
